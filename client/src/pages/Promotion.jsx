...
function Promotion() {
  const options = [
    { label: '1k', amount: 700 },
    { label: '2k', amount: 1300 },
    { label: '3k', amount: 1900 },
    { label: '4k', amount: 2500 },
    { label: '5k', amount: 3000 },
  ];
    ...
    <div>
      ...
      <div className='container'>
        <div className='text-center d-flex justify-content-center mt-3'> 
          <h3 className='bg-warning p-4 w-50'>Channel Promotion</h3>
        </div>
        ...
        <div className='d-flex justify-content-center'>
          <button className='btn btn-secondary mt-5' onClick={handleOpenPopup} disabled={!isChecked}>Payment Method</button>
        </div>
        <div>
          <Personaladd />
        </div>
      </div>
      {openPopup && <Popup onClose={handleClosePopup} selectedAmount={selectedOption} type={'channel'}/>}
    </div>
  );
}
